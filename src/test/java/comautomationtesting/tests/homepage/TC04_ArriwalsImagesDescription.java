...
public class TC04_ArriwalsImagesDescription {
    @Test
    public void ArriwalsImagesDescription() {
        ...
        ReusableMethods.clickWithJS(productPage.reviewsButtonProduct);
        Reporter.log("Kullanici Reviews butona tiklar");
        ReusableMethods.clickWithJS(productPage.descriptionButtonProduct);
        Reporter.log("Kullanici Description butona tiklar");
        //11) There should be a description regarding that book the user clicked on
        Assert.assertTrue(productPage.textProductDescriptionProduct.isDisplayed());
        Reporter.log("Kullanici Product Description yazisinin gorunurlugunu dogrular");
        Driver.closeDriver();
    }
