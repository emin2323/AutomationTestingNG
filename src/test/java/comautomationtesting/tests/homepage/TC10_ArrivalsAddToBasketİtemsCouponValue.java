...
public class TC10_ArrivalsAddToBasketİtemsCouponValue {
    @Test
    public void ArriwalsAddToBasketItemsCouponValue() {
        ...
        //15) User can not able to apply coupon by entering ‘krishnasakinala’ in the
        // coupon textbox which give 50rps off on the total price because the coupon is applicable for the book price > 450 rps
        Assert.assertTrue(basketPage.couponKrishnasakinalaBasket.isDisplayed());
        Reporter.log("Kullanici indirim kuponunu goruntuler");
        Driver.closeDriver();
    }
}
