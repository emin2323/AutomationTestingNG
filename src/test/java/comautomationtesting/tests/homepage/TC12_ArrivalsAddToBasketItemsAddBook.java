...
public class TC12_ArrivalsAddToBasketItemsAddBook {
    @Test
    public void ArrivalsAddToBasketItemsAddBook() {
        ...
        basketPage.textBoxQuantityBasket.click();
        basketPage.textBoxQuantityBasket.clear();
        Reporter.log("Kullanici quantity textboxina tiklar ve temizler");
