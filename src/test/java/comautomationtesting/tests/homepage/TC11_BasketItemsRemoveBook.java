...
public class TC11_BasketItemsRemoveBook {
    @Test
    public void BasketItemsRemoveBook() {
        ...
        Assert.assertTrue(basketPage.proceedToCheckoutButtonBasket.isDisplayed());
        ReusableMethods.clickWithJS(basketPage.removeSymbolBasket);
        Reporter.log("Kullanici checkout butonunu goruntuler ve urunu silecegi kisma tiklayabilir");
        Driver.closeDriver();
    }
}
