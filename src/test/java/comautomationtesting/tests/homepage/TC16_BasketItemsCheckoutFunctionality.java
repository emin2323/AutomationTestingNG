...
public class TC16_BasketItemsCheckoutFunctionality {
    ...
    public void testName() {
        ...
        Reporter.log("Odeme sayfasinda oldugu gorulur");
        ...
        Assert.assertTrue(checkoutPage.placeOrderButtonCheckout.isDisplayed());
        Reporter.log("Odeme sayfasinda oldugu dogrulanir");
        Driver.closeDriver();
