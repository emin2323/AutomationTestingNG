...
public class TC17_AddToBasketItemsCheckoutPaymentGateway {
    ...
    public void AddToBasketItemsCheckoutPaymentGateway() throws InterruptedException {
        ...
        Thread.sleep(1000);
        checkoutPage.phoneNameCheckout.sendKeys(Faker.instance().phoneNumber().phoneNumber(),Keys.TAB,Keys.ARROW_UP,Keys.ARROW_DOWN,Keys.ENTER);
        Thread.sleep(1000);
        ...
        Assert.assertTrue(checkoutPage.haveACouponLinkCheckout.isDisplayed());
        Assert.assertTrue(checkoutPage.textBillingDetailsCheckout.isDisplayed());
        Assert.assertTrue(checkoutPage.textAdditionalInformationCheckout.isDisplayed());
        Assert.assertTrue(checkoutPage.textYourOrderCheckout.isDisplayed());
        Driver.closeDriver();
